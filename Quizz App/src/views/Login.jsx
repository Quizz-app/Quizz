    ...
    <AnimatePresence mode='wait'>
      ...
      >
        ...
        <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black mt-10">
          ...
          <button
            className=" mt-5 bg-gradient-to-br relative group/btn from-custom-blue dark:from-zinc-900 dark:to-zinc-900 to-black block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
            type="submit"
            onClick={login}
          >
            Login &rarr;
