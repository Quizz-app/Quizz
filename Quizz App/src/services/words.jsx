import colaborativeEditing from '../images/colaborativeEditing.png';
...
export const content = [
    {
        ...
        description:
            "Work together in real time with your team or student class. Collaborate on quizzes, share ideas, and make decisions quickly. With our platform, you can streamline your workflow and increase productivity.",
        content: (
            <div className="h-[400px] w-[750px]">
                <img src={colaborativeEditing} alt="Collaborative Editing" className="h-full w-full " />
            </div>
    ...
    },
    {
        ...
        description:
            "See changes as they happen. With our platform, you can track every modification in real time. No more confusion about the latest version of your quizz. Say goodbye to the chaos of version control and embrace the simplicity of real-time updates.",
        content: (
            <div className="h-[400px] w-[750px]">
                <img src={colaborativeEditing} alt="Collaborative Editing" className="h-full w-full " />
            </div>
    ...
    },
    {
        ...
        content: (
            <div className="h-[400px] w-[800px]">
                <img src={versionControl} alt="Collaborative Editing" className="h-full w-full " />
            </div>
