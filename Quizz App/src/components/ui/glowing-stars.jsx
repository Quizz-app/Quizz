...
export const GlowingStarsBackgroundCard = ({ className, children }) => {
    ...
    return (
        <div
            ...
            className={cn(
                "bg-[linear-gradient(110deg,#fff,#ccc)] p-4 max-w-md max-h-[20rem] h-full w-full rounded-xl border border-[#eaeaea] dark:border-neutral-600",
                className
            )}
        >
...
GlowingStarsBackgroundCard.propTypes = {
    children: PropTypes.node,
    className: PropTypes.string,
};

GlowingStarsDescription.propTypes = {
    children: PropTypes.node,
    className: PropTypes.string,
};

GlowingStarsTitle.propTypes = {
    children: PropTypes.node,
    className: PropTypes.string,
};
