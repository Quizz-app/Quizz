...
import { getUserTeamInvites, respondToInvite } from "../services/users-service";
...
const Header = ({ theme, onThemeChange }) => {
  ...
  const handleInviteResponse = async (teamId, accept) => {
    respondToInvite(userData.username, teamId, accept);
  }
    ...
    <div className="navbar bg-base-100 flex justify-between">
      ...
      <div className="flex-none gap-2 mr-3">
        {!user ? (
          ...
          <>
            {teamInvites.length > 0 && (<div className="indicator">
                    ...
                    {teamInvites.map((invite, index) => (
                      <li key={index}>
                        <div className="flex flex-col">
                          <p>
                            Имате покана от {invite.inviter} за отбор {invite.teamName}
                          </p>
