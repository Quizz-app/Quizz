...
const Header = ({ theme, onThemeChange }) => {
  ...
  return (
    <div className="navbar bg-neutral flex justify-between rounded-md shadow-lg">
      <div className="flex-2">
        <h1 className="text-2xl text-center font-bold ml-5 cursor-pointer" onClick={() => navigate("/")}>Brain</h1>
        <h1 className="text-2xl text-center font-bold cursor-pointer text-blue-300" onClick={() => navigate("/")}>Burst.</h1>

      </div>
      {userData && (
        <div>
          <div className="flex items-center justify-center ">
            <Link to="/home" className="font-bold  mr-8">  Home </Link>
            <Link to="/dashboard" className="font-bold  mr-8">  Dashboard </Link>
            <Link to="/my-library" className="font-bold  mr-8"> Library </Link>
        ...
        {!user ? (
          ...
          <>
            ...
            <label className="swap swap-rotate">
              ...
              <input type="checkbox" className="theme-controller" value='aqua' />
              {/* sun icon */}
