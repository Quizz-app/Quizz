    ...
    <CardContainer className=" w-64 h-64 flex-shrink-0 mr-5 p-0">
      <CardBody className="bg-gradient-to-br from-blue-400 to-custom-blue relative group/card shadow-custom-light dark:hover:shadow-custom-dark dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.1] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-4">
        ...
        <CardItem
          as="p"
          translateZ="100"
          className="text-[#00ff8c] text-sm max-w-sm mt-2 dark:text-dark-300 text-left font-bold truncate overflow-hidden overflow-ellipsis whitespace-nowrap max-w-xs h-20"
        >
          {quiz?.description}
        </CardItem>
